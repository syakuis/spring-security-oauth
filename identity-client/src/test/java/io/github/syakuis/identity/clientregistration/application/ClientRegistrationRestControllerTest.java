...
import io.github.syakuis.identity.clientregistration.application.restdocs.ClientRegistrationField;
...
import io.github.syakuis.identity.restdocs.AutoConfigureMvcRestDocs;
import io.github.syakuis.identity.restdocs.RestDocsFieldHandler;
...
class ClientRegistrationRestControllerTest {
    ...
    void register() throws Exception {
        ...
        when(clientRegistrationService.register(any())).thenReturn(clientRegistrationDto);
