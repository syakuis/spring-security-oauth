...
public class SignupAccountService {
    ...
    public Optional<Account> account(String username) {
        ...
        Optional<AccountEntity> accountDetailsEntityOptional = accountRepository
            .findByUsername(username);

        if (accountDetailsEntityOptional.isEmpty()) {
            return Optional.empty();
        }

        return Optional.of(AccountMapper.INSTANCE.toDto(accountDetailsEntityOptional.get()));
    }
